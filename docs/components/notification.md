...
=======
title: Notification | Bobo-Element
>>>>>>> master
...
=======
<preview path="../demo/Notification/Type.vue" title="不同状态" description="Notification 不同状态"></preview>
>>>>>>> master
...
=======
<preview path="../demo/Notification/Icon.vue" title="自定义图标类型" description="Notification 自定义图标"></preview>
