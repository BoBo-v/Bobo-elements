...
<preview path="../demo/Message/Types.vue" title="不同状态" description="Message 不同状态"></preview>
...
<preview path="../demo/Message/Duration.vue" title="可关闭的消息提示" description="Message 可关闭"></preview>
